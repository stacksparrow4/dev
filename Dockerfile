...
RUN apt-get update && apt-get install -y python3 python3-pip sudo gcc git openssl libssl-dev vim php-cli curl wget gdb file netcat-openbsd sslscan nmap binwalk exiftool tmux neovim hydra lftp ftp ncat ffuf gobuster golang unzip zip python3-pwntools python3-ropgadget nasm sagemath
